...
| [learning-exercises.design.md](project/learning-exercises.design.md) | `**/*` | Progressive debugger tours, reversible experiments, prerequisite links, exercise-pack structure |
| [simplicity-first.design.md](project/simplicity-first.design.md) | `**/*` | Prefer clear good-enough solutions, disclose better alternatives, justify added complexity |
